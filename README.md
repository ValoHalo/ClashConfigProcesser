...
该仓库同样提供了yaml配置文件，相对脚本精简了一些地区策略组，没有倍率识别等，由于yaml的局限性导致实现的效果没有脚本的好，有需要的可查看：[mihomoConfig.yaml](https://github.com/AIsouler/MyClash/blob/main/Config/mihomoConfig.yaml)
