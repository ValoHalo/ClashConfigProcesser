...
const prefixRules = [
  ...
  // 学术出版、文献检索与预印本
  'DOMAIN-SUFFIX,cnki.net,直连',
  'DOMAIN-SUFFIX,cnki.com.cn,直连',
  'DOMAIN-SUFFIX,wanfangdata.com.cn,直连',
  'DOMAIN-SUFFIX,cqvip.com,直连',
  'DOMAIN-SUFFIX,sciencedirect.com,直连',
  'DOMAIN-SUFFIX,elsevier.com,直连',
  'DOMAIN-SUFFIX,els-cdn.com,直连',
  'DOMAIN-SUFFIX,scopus.com,直连',
  'DOMAIN-SUFFIX,springer.com,直连',
  'DOMAIN-SUFFIX,springerlink.com,直连',
  'DOMAIN-SUFFIX,springernature.com,直连',
  ...
  'DOMAIN-SUFFIX,geotechniqueletters.com,直连',
  'DOMAIN-SUFFIX,mdpi.com,直连',
  'DOMAIN-SUFFIX,frontiersin.org,直连',
  'DOMAIN-SUFFIX,plos.org,直连',
  'DOMAIN-SUFFIX,biomedcentral.com,直连',
  'DOMAIN-SUFFIX,arxiv.org,直连',
  'DOMAIN-SUFFIX,biorxiv.org,直连',
  'DOMAIN-SUFFIX,medrxiv.org,直连',
  'DOMAIN-SUFFIX,ssrn.com,直连',
  'DOMAIN-SUFFIX,ncbi.nlm.nih.gov,直连',
  'DOMAIN-SUFFIX,doi.org,直连',
  'DOMAIN-SUFFIX,crossref.org,直连',
  'DOMAIN-SUFFIX,orcid.org,直连',
  'DOMAIN-SUFFIX,webofscience.com,直连',
...
function buildDnsAndHostsConfig(
  ...
  const dns = {
    ...
    'fake-ip-filter': [
      ...
      ...(finalRuleProviders.googlefcm ? ['rule-set:googlefcm'] : []),
      ...proxyFakeIpFilter,
    ],
